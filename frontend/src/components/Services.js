...
import { services } from "../data/mock"; // Mock data import
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            ...
            professional expertise, cinematic vision, and artistic storytelling.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {services.map((service) => {
            ...
            return (
              <Card
                key={service.id}
                className="group relative overflow-hidden border-0 bg-transparent hover:transform hover:scale-105 transition-all duration-500"
              >
                ...
                <CardContent className="relative z-10 p-8 h-96 flex flex-col justify-end">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${service.color} mb-6 transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
        ...
        <div className="text-center mt-16">
          ...
          >
            <Camera
              className="mr-3 text-purple-400 group-hover:scale-110 transition-transform duration-200"
              size={20}
            />
            <span className="text-white font-medium">
              Need something custom? Let's create it together
            </span>
            <ArrowRight
              className="ml-3 text-pink-400 group-hover:translate-x-1 transition-transform duration-200"
              size={20}
            />
          </a>
        </div>
